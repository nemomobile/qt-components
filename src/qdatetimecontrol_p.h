...
#ifndef QDATETIMECONTROL_P_H
#define QDATETIMECONTROL_P_H
...
class QDateTimeControlPrivate : public QObjectPrivate, public QDateTimeParser
{
    Q_DECLARE_PUBLIC(QDateTimeControl)
public:
