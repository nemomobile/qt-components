...

{
    Q_OBJECT
public:
    tst_quickcomponentsbusyindicator();
...
void tst_quickcomponentsbusyindicator::value()
{
...
void tst_quickcomponentsbusyindicator::minimumValue()
{
    // check presence of property and set initial value
    QVERIFY( componentObject->setProperty( "minimumValue", 0.0 ) );
...
void tst_quickcomponentsbusyindicator::maximumValue()
{
    // check presence of property and set initial value
    QVERIFY( componentObject->setProperty( "maximumValue", 100.0 ) );
...
void tst_quickcomponentsbusyindicator::indeterminate()
{
    // check presence of property and set initial value
