...
tst_quickcomponentstoolbar::tst_quickcomponentstoolbar()
{
    ...
    QFile file("tst_quickcomponentstoolbar.qml");
...
void tst_quickcomponentstoolbar::children()
{
