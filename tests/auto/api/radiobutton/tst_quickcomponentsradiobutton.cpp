...

{
    Q_OBJECT
public:
    tst_quickcomponentsradiobutton();
...
void tst_quickcomponentsradiobutton::clicked()
{
   ...
   QVERIFY( QMetaObject::invokeMethod( componentObject, "clicked", Qt::DirectConnection ) );
